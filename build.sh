...
getsource () {
    ...
    echo Patch MSM-5.4
    cd common/kernel/
    git clone --depth=1 https://github.com/sunscape-stuff/msm-5.4 msm-5.4
    cd ../../
    set +x
}
gettools () {
...
startbuild () {
    ...
    if [ $KSU = 1 ]; then
        ...
        curl -LSs "https://raw.githubusercontent.com/lenonarddo/KernelSU/refs/heads/main/kernel/setup.sh" | bash -
        else
